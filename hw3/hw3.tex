...
\begin{document}
    ...
    \subsubsection*{Example Phonotactically Sound Words}
    \begin{itemize}
        \item wùg \textipa{/wuN\tone{51}/}
        \item słygiz \textipa{/s\L{}1Ni\t{ts}\tone{33}/}
        \item hengó \textipa{/henNA\tone{35}/}
        \item rõk \textipa{/\:R\~*Ak\tone{11}/}
        \item kłas \textipa{/k\L{}\~*\ae{}s\tone{13}/}
    \end{itemize}
